...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
  ...
  <!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">信息技术与物流能力问题划分</h1>
                    <a class='btn btn-primary' href="/fofs/1/index.php/Admin/Company/new_ability">新增</a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                        ...
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                              <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                                  ...
                                                  <td><?php echo ($vo['question_en']); ?></td>
                                                  <td>
                                                      <?php switch($vo['is_multiple_answer']): case "0": ?>单选<?php break;?>
                                                          <?php case "1": ?>多选<?php break; endswitch;?>
                                                  </td>
                                                  <td>
                                                    <a class='btn btn-primary' href="/fofs/1/index.php/Admin/Company/edit_ability/id/<?php echo ($vo['id']); ?>">编辑</a>
                                                  </td>
                                                  <td>
                                                    <a class='btn btn-primary' href="/fofs/1/index.php/Admin/Company/delete_ability/id/<?php echo ($vo['id']); ?>">删除</a>
                                                  </td>
