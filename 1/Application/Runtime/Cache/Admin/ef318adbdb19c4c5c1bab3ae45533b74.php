...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
  ...
  <!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">添加体系标准</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <form action='/fofs/1/index.php/Admin/Criteria/add_new_system' method='post'>
                <div class="form-group col-sm-6">
                    <label>体系标准名称</label>
                    <input class='form-control' id='name' placeholder='体系标准名称' type='text' name='name'/>
                </div>
