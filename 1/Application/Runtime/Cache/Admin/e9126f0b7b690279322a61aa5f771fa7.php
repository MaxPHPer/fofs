...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
  ...
  <!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">添加职能</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <form action='/fofs/1/index.php/Admin/System/add_new_function' method='post'>
                <div class="form-group col-sm-6">
                  <label>职能名称</label>
                  <input class='form-control' id='name' placeholder='职能名称' type='text' name='name'/>
                </div>
                <div class="clearfix"></div>
                <div class="form-group col-sm-6">
                  <label>英文</label>
                  <input class='form-control' id='name_en' placeholder='英文' type='text' name='name_en'/>
                </div>
                <div class="clearfix"></div>
                <div class="form-group col-sm-6">
