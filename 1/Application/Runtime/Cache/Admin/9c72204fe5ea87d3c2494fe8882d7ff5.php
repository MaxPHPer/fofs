...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
  ...
  <!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">公司类型划分</h1>
                    <a class='btn btn-primary' href="/fofs/1/index.php/Admin/Company/new_company">新增</a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                        ...
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                              <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                                  ...
                                                  <td>
                                                    <a class='btn btn-primary' href="/fofs/1/index.php/Admin/Company/edit_company/id/<?php echo ($vo['id']); ?>">编辑</a>
                                                  </td>
                                                  <td>
                                                    <a class='btn btn-primary' href="/fofs/1/index.php/Admin/Company/delete_company/id/<?php echo ($vo['id']); ?>">删除</a>
                                                  </td>
