...
<!--         <li><a href="#"><i class="fa fa-user fa-fw"></i> User Profile</a>
  ...
  <div id="page-wrapper">
    ...
    <div class="row">
        ...
        <form action="<?php echo U('Admin/Article/do_edit_article');?>" method='post'>
                    ...
                    <div class='box-content'>
                      <table class='table table-striped table-bordered' id='inplaceediting-user' style='margin-top: 20px'>
                        ...
                        <tr>
                          ...
                          <td style='width:90%'>
                            <input type='text' name='title' placeholder='标题' value="<?php echo ($article['title']); ?>" />
                          </td>
                        </tr><!--帮助标题-->
                        <tr>
                        ...
                        <tr  >
                          ...
                          <td >
                             <script id="editor" name='content' type="text/plain" style="width:900px;height:500px;"><?php echo ($article['content']); ?></script>
                          </td>
                        </tr><!--内容-->
                        <tr>
                        </tr>
