        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
              <div class="row borderNo">
                <div class="col-sm-8">
                  <?php if($info['face_url'] != NULL): ?><img class="media-object img-thumbnail" src="/fofs/1/Public/uploads/supplier_pic/<?php echo ($info['face_url']); ?>" alt="头像">
                  <?php else: ?>
                    <img class="media-object img-thumbnail" src="/selectin/1/Public/uploads/supplier_pic/temp.jpg" alt="头像"><?php endif; ?>
                </div>
              </div><!--上传头像-->
              <div class="row borderNo">
                <label class="col-sm-3 control-label"><?php echo (L("user_name")); ?></label>
                <div class="col-sm-8">
                  <p><?php echo ($info['username']); ?></p>
                </div>
              </div><!--用户名-->
              <div class="row borderNo">
                <label class="col-sm-3 control-label"><?php echo (L("first_name")); ?></label>
                <div class="col-sm-3">
              ...
              <div class="row borderNo">
                <label class="col-sm-3 control-label"><?php echo (L("first_name")); ?>(<?php echo (L("lang_english")); ?>)</label>
                <div class="col-sm-3">
              ...
              <div class="row borderNo">
                <label class="col-sm-3 control-label"><?php echo (L("position")); ?></label>
                <div class="col-sm-3">
              ...
              <div class="row borderNo">
                <label class="col-sm-3 control-label"><?php echo (L("email")); ?></label>
                <div class="col-sm-8">
                  <p><?php echo ($info['email']); ?></p>
                </div>
              </div><!--电子邮件-->
              <div class="row borderNo">
                <label class="col-sm-3 control-label"><?php echo (L("telephone")); ?></label>
                <div class="col-sm-2">
                  <p><?php echo ($info['tel']); ?></p>
                </div>
              </div><!--电话号码-->
              <div class="row borderNo">
                <label class="col-sm-3 control-label"><?php echo (L("mobile_phone")); ?></label>
                <div class="col-sm-2">
                  <p><?php echo ($info['mobile']); ?></p>
                </div>
              </div><!--手机-->
              <div class="row borderNo">
                <label class="col-sm-3 control-label"><?php echo (L("fax")); ?></label>
                <div class="col-sm-2">
            ...
            <div class="row" style="margin: 50px 0 20px">
              <div class="col-sm-4 col-sm-offset-2">
                <a href="/fofs/1/index.php/Admin/User/viewbuyerCompanyInfo/id/<?php echo ($info['buyer_company_id']); ?>" type="button" class="btn btn-block btn-primary"><?php echo (L("view_company")); ?></a>
              </div>
              <div class="col-sm-4">
                <a href="javascript:;" onClick="javascript:history.back(-1);" type="button" class="btn btn-primary btn-block"><?php echo (L("back")); ?></a>
              </div>
            </div>
          </div>
        </div>
