...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
  ...
  <!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">查看所有供应商</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                        ...
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                              <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                                  ...
                                                  <td><?php echo $comlist[$vo['supplier_company_id']]?$comlist[$vo['supplier_company_id']]:'未填写公司信息'; ?></td>
                                                  <td>
                                                  ...
                                                  <td>
                                                    <?php if(($vo[state] == 1) OR ($vo[state] == 2) OR ($vo[state] == -1)): ?><a class='btn btn-primary' href="/fofs/1/index.php/Admin/User/viewsupplierPersonalInfo/id/<?php echo ($vo['id']); ?>">查看详细信息</a><?php endif; ?>
                                                  </td>
