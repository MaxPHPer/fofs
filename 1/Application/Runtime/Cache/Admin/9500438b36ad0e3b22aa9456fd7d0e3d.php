...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
  ...
  <!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">查看所有采购商</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                        ...
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                              <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                                  ...
                                                  <td><?php echo $comlist[$vo['buyer_company_id']]?$comlist[$vo['buyer_company_id']]:'未填写公司信息'; ?></td>
                                                  <td>
                                                      <?php switch($vo[state]): case "1": ?>正常<?php break;?>
                                                        <?php case "2": ?>停用<?php break;?>
                                                        <?php case "-1": ?>丢失<?php break;?>
                                                        <?php default: ?>未验证<?php endswitch;?>
                                                  </td>
                                                  <td><?php echo date('Y-m-d H:i:s',$vo['reg_time']); ?></td>
                                                  <td>
                                                    <?php if(($vo[state] == 1) OR ($vo[state] == 2) OR ($vo[state] == -1)): ?><a class='btn btn-primary' href="/fofs/1/index.php/Admin/User/viewbuyerPersonalInfo/id/<?php echo ($vo['id']); ?>">详细</a><?php endif; ?>
                                                    <?php if(($vo[state] == 1) OR ($vo[state] == 2) OR ($vo[state] == -1)): ?><a class='btn btn-danger' href="/fofs/1/index.php/Admin/User/delete/id/<?php echo ($vo['id']); ?>">删除</a><?php endif; ?>
                                                  </td>
