    ...
    <div class="sidebar-nav navbar-collapse">
      <ul class="nav" id="side-menu">
        ...
        <li>
          ...
          <ul class="nav nav-second-level">
            <li>
              <a href="/fofs/1/index.php/Admin/Article/add_article">新添新闻</a>
            </li>
            <li>
              <a href="/fofs/1/index.php/Admin/Article/all_news">查看所有新闻</a>
            </li>
          </ul>
          <!-- /.nav-second-level -->
        </li>
                          ...
                          <a href="<?php echo U('Admin/Article/article_detail');?>?article_id=<?php echo ($vo['id']); ?>" >
                            ...
                            <div style="float: right;">
                              <div style="float: right; margin-right:25px;">
                                <a href="<?php echo U('Admin/Article/delete_article');?>?article_id=<?php echo ($vo['id']); ?>" >
                                  <span class="glyphicon glyphicon-remove"></span>
                                  删除
                                </a>
                              </div>
                              <div style="float: right; margin-right:25px;">
                                <a href="<?php echo U('Admin/Article/edit_article');?>?article_id=<?php echo ($vo['id']); ?>" >
