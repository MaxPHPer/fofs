                                                  ...
                                                  <div class="modal-dialog">
                                                    <div class="modal-content">
                                                      ...
                                                      <div class="modal-footer">
                                                        <a href="<?php echo U('Home/Sa/sendLetter');?>?user_id=<?php echo ($vo['sender_id']); ?>&institution_type=<?php echo ($vo['sender_type']); ?>&username=<?php echo ($vo['sender_name']); ?>"><button type="button" class="btn btn-primary">回复</button></a>
