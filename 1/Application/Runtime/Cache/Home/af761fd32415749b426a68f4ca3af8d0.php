    ...
    <section class="content-wrap">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="well">
              <h3>所有基金&nbsp;(<a href="<?php echo U('Home/Gp/addFund');?>">添加新基金</a>)</h3>
              <hr/>
                  ...
                  <div class='col-md-12'>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-body">
                          ...
                          <?php if(is_array($funds)): foreach($funds as $key=>$vo): ?><div class="row margin_top_20">
                                <div class="col-sm-3 text_right">
                                  <label for="userName" > <span class="glyphicon glyphicon-th-list"></span><b>基金产品 <?php echo ($key+1); ?>:</b></label>
                                </div>
                                <div class="col-sm-9 text_right">
                                            <span class="glyphicon glyphicon-pencil"></span><a href="<?php echo U('Home/Gp/modifyFund');?>?id=<?php echo ($vo['id']); ?>">修改</a>&nbsp;<span class="glyphicon glyphicon-trash"></span><a href="<?php echo U('Home/Gp/deleteFund');?>?id=<?php echo ($vo['id']); ?>">删除</a>
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-top:10px;">
                                ...
                                <div>
                                    ...
                                    <div class="col-sm-8">
                                      ...
                                      <div class="col-sm-4 ">
                                          <a href="/fofs/1/Public/uploads/gp_recruitment/<?php echo ($vo['recruitment_plan_url']); ?>" target="_Blank"><?php echo ($vo['recruitment_plan_url']); ?></a>
                                      </div>  
