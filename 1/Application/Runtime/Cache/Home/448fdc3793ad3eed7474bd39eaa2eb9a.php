    ...
    <section class="content-wrap">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="well">
              <h3>添加新<?php if($user['institution_type'] == 4): ?>成功案例<?php else: ?>产品服务<?php endif; ?></h3>
              <hr/>
            <form class="form-horizontal" action=""  method="post" name='form1'>
                        ...
                        <?php if($user['institution_type'] == 4): ?><div class="repeat">
                              ...
                              <div class="row" style="margin-top:10px;">
                                  ...
                                  <div>
                                      ...
                                      <div class="col-sm-4">
                                        <input type="number" class="form-control" id="investment_quota" name="investment_quota"  value="<?php echo ($vo['investment_quota']); ?>"  />                            
                                      </div>
              ...
              <div class="row">
                  <div class="col-sm-3">
                    <button type="submit" class="btn btn-primary" id="" onclick="form1.action='/fofs/1/index.php/Home/Sa/do_addCase';form1.submit();">确认添加</button>
                  </div>
              </div>
