  ...
  <div class="container">
                ...
                <div class="repeat_fund ">
                  ...
                  <?php if(is_array($funds)): foreach($funds as $key=>$vo): ?><div class="row">
                    ...
                    <div class="row" style="margin-top:10px;">
                        ...
                        <div>
                            <div class="col-sm-2">
                              <label for="investment_region" class="col-sm-12 control-label">
                                投资地域
                              </label>
                            </div>
                            <div class="col-sm-4">
                              <input type="text" class="form-control" id="investment_region" name="investment_region"  placeholder="海外\全国范围\某省某市" value="<?php echo ($vo['investment_region']); ?>" disabled/>                            
                            </div>
                    ...
                    <div class="row" style="margin-top:10px;">
                        ...
                        <div>
                            ...
                            <div class="col-sm-10">
                              ...
                              <div class="col-sm-4 ">
                                  <a href="/fofs/1/Public/uploads/gp_recruitment/<?php echo ($vo['recruitment_plan_url']); ?>" target="_Blank" class="form-control"><?php echo ($vo['recruitment_plan_url']); ?></a>
                              </div>  
              ...
              <form action="" method="post" enctype="multipart/form-data" name="form1">
                    ...
                    <div class="row" style="margin-top:10px;">
                        ...
                        <div>
                            ...
                            <div class="col-sm-4">
                              <input type="text" class="form-control" id="investment_region" name="investment_region"  placeholder="海外\全国范围\某省某市"/>                            
                            </div>
                ...
                <div class="row">
                      <div class="col-sm-2">
                        <button type="submit" class="btn btn-primary" id="" onclick="form1.action='/fofs/1/index.php/Home/Register/add_gpFundsInfo';form1.submit();">添加其它基金产品</button>
                      </div>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-sm-4 col-sm-offset-4" style="margin-bottom:30px;">
          <input type="submit" class="btn btn-primary btn-block" id="submit" value="<?php echo (L("signup_complete")); ?>" onclick="form1.action='/fofs/1/index.php/Home/Register/save_gpFundsInfo';form1.submit();"/>
        </div>
      </div>
    </form>
  </div>
