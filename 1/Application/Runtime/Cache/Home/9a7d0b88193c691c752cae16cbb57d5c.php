          ...
          <div class="col-md-8">
            <div class="well">
              ...
              <div class="row margin_top_20">
                  <div class='col-md-12'>
                    <h3><span class="glyphicon glyphicon-home"></span>管理团队&nbsp;(<a href="<?php echo U('Home/Gp/addMember');?>">添加新成员</a>)</h3>
                    <div class="panel panel-default">
                      <div class="panel-body">
                          <!--已有团队成员-->
                                    ...
                                    <div class="borderBottom" style="margin-bottom:20px;">
                                      <div class="row" >
                                        ...
                                        <div class="col-sm-5 text_right">
                                            <span class="glyphicon glyphicon-pencil"></span><a href="<?php echo U('Home/Gp/modifyMember');?>?id=<?php echo ($vo['id']); ?>">修改</a>&nbsp;<span class="glyphicon glyphicon-trash"></span><a href="<?php echo U('Home/Gp/deleteMember');?>?id=<?php echo ($vo['id']); ?>">删除</a>
                                        </div>
