                                ...
                                <div class="list-group">
                                    <?php if(is_array($personal_followings)): foreach($personal_followings as $key=>$vo): ?><div class="list-group-item row form-group">
                                            ...
                                            <div class="col-sm-2 text_right margin_top_13">
                                                <span class="glyphicon glyphicon-envelope"></span><a href="<?php echo U('Home/Sa/sendLetter');?>?user_id=<?php echo ($vo['host_id']); ?>&institution_type=<?php echo ($vo['host_type']); ?>&username=<?php echo ($vo['nickname']); ?>">发信</a>
                                            </div>
                              ...
                              <div class="panel-body">
                                <div class="list-group">
                                    <?php if(is_array($institution_followings)): foreach($institution_followings as $key=>$vo): ?><div class="list-group-item row form-group">
                                            ...
                                            <div class="col-sm-2 text_right margin_top_13">
                                                <span class="glyphicon glyphicon-envelope"></span><a href="<?php echo U('Home/Sa/sendLetter');?>?user_id=<?php echo ($vo['host_id']); ?>&institution_type=<?php echo ($vo['host_type']); ?>&username=<?php echo ($vo['institution_abbr']); ?>">发信</a>
                                            </div>
