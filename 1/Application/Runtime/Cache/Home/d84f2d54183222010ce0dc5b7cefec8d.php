              ...
              <div class="panel-body">
                <div class="row">
                  <div class="col-sm-10 col-sm-offset-1">
                    ...
                    <div class="form-group clearfix">
                      <label for="services_and_fees" class="col-sm-3 control-label">服务内容和简介</label>
                      <div class="col-sm-8">
                        <textarea class="form-control"  name="services_and_fees"></textarea>
                      </div>
                    </div>
                    <!--服务内容和简介-->
              ...
              <div class="panel-body">
                <div class="row">
                  <div class="col-sm-10 col-sm-offset-1">
                    ...
                    <div class="form-group clearfix">
                      <label for="contact_telephone" class="col-sm-3 control-label">传真</label>
                      <div class="col-sm-8">
                    ...
                    <div class="form-group clearfix">
                      <label for="contact_mobilephone" class="col-sm-3 control-label">电话</label>
                      <div class="col-sm-8">
