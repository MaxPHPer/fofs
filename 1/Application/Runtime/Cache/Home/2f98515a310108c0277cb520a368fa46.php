                    ...
                    <?php if(is_array($funds)): foreach($funds as $key=>$vo): ?><div class="row">
                            ...
                            <div>
                                ...
                                <div class="col-sm-4">
                                    <select name="fund_property" id="fund_property" class="form-control">
                                       <?php if($vo['is_angel_investment'] == 1): ?><option value='1' selected>天使投资基金</option><?php else: ?><option value='1'>天使投资基金</option><?php endif; ?>
                                       <?php if($vo['is_vc_investment'] == 1): ?><option value='2' selected>VC基金</option><?php else: ?><option value='2'>VC基金</option><?php endif; ?>
                                       <?php if($vo['is_pe_investment'] == 1): ?><option value='3' selected>PE基金</option><?php else: ?><option value='3'>PE基金</option><?php endif; ?>
                                       <?php if($vo['is_other_investment'] == 1): ?><option value='4' selected>其它基金</option><?php else: ?><option value='4'>其它基金</option><?php endif; ?>
                        ...
                        <div class="row" style="margin-top:10px;">
                            ...
                            <div>
                                ...
                                <div class="col-sm-4">
                                  <input type="text" class="form-control" id="investment_region" name="investment_region"  value="<?php echo ($vo['investment_region']); ?>"/>                            
                                </div>
                        ...
                        <div class="row" style="margin-top:10px;">
                            ...
                            <div>
                                ...
                                <div class="col-sm-9">
                                  ...
                                  <div class="col-sm-4 ">
                                    <?php if($vo['recruitment_plan_url']): ?><a href="/fofs/1/Public/Uploads/gp_recruitment/<?php echo ($vo['recruitment_plan_url']); ?>" target="_Blank">已传方案</a><?php endif; ?>
                        ...
                        <?php if(is_array($vo['investment_projects'])): foreach($vo['investment_projects'] as $project_key=>$investment_project): ?><div class="row" style="margin-top:10px;">
                                      <div>
                                          ...
                                          <div class="col-sm-3 text_right">
                                              <span class="glyphicon glyphicon-trash"></span><a href="<?php echo U('Home/Gp/deleteInvestment');?>?id=<?php echo ($investment_project['id']); ?>">删除</a>
                                          </div>
                        ...
                        <div class="row">
                              <div class="col-sm-3">
                                <button type="submit" class="btn btn-primary" id="" onclick="form1.action='/fofs/1/index.php/Home/Gp/do_modifyFund';form1.submit();">保存修改</button>
                              </div>
                        </div><?php endforeach; endif; ?>
