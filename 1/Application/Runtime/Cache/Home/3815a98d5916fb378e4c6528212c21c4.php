    ...
    <section class="content-wrap">
      <div class="container">
        <div class="row margin_top_bottom_20">
          ...
          <div class="col-md-8">
          <form class="form-horizontal" action="<?php echo U('Home/Startups/save_modifyCompanyInfo');?>"  method="post" name='form1' enctype="multipart/form-data">
              <div class="well">
                <h3>修改公司信息</h3>
                <hr/>
                ...
                <div class="row">
                    ...
                    <div class='col-md-10'>
                        <div class="row">
                            ...
                            <div class='col-md-10'>
                                <input type="text" class="form-control" name="institution_abbr" value="<?php echo ($user['institution_abbr']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="row margin_top_bottom_20">
                            ...
                            <div class='col-md-10'>
                                <input type="text" class="form-control" name="institution_vision" value="<?php echo ($user['institution_vision']); ?>">
                            </div>
                        </div>
                      ...
                      <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="row margin_top_bottom_20">
                                ...
                                <div class='col-md-8'>
                                    <textarea name="user_pain_points" class="form-control"><?php echo ($user['user_pain_points']); ?></textarea>
                                </div>
                            </div>

                            <div class="row margin_top_bottom_20">
                              <div class='col-md-3 text_right'>解决方案:</div>
                              <div class='col-md-8'><textarea name="solutions" class="form-control"><?php echo ($user['solutions']); ?></textarea></div>
                            </div>

                            <div class="row margin_top_bottom_20">
                              <div class='col-md-3 text_right'>核心资源:</div>
                              <div class='col-md-8'><textarea name="core_resources" class="form-control"><?php echo ($user['core_resources']); ?></textarea></div>
                            </div>

                            <div class="row margin_top_bottom_20">
                              <div class='col-md-3 text_right'>盈利模式:</div>
                              <div class='col-md-8'><textarea name="profit_model" class="form-control"><?php echo ($user['profit_model']); ?></textarea></div>
                            </div>
                      ...
                      <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="row margin_top_bottom_20">
                                ...
                                <div class='col-md-8'>
                                    <textarea name="market_situation" class="form-control"><?php echo ($user['market_situation']); ?></textarea>
                                </div>
                            </div>

                            <div class="row margin_top_bottom_20">
                              <div class='col-md-3 text_right'>竞品分析:</div>
                              <div class='col-md-8'><textarea name="competitive_analysis" class="form-control"><?php echo ($user['competitive_analysis']); ?></textarea></div>
                            </div>

                            <div class="row margin_top_bottom_20">
                              <div class='col-md-3 text_right'>优势分析:</div>
                              <div class='col-md-8'><textarea name="advantage_analysis" class="form-control"><?php echo ($user['advantage_analysis']); ?></textarea></div>
                            </div>
                      ...
                      <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="row margin_top_bottom_20">
                                ...
                                <div class='col-md-8'>
                                    <input type="text" class="form-control" name="contact_wechat" value="<?php echo ($user['contact_wechat']); ?>">
                                </div>
                            </div>
                            <div class="row margin_top_bottom_20">
                                <div class='col-md-3 text_right'>
                      ...
                      <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="row margin_top_bottom_20">
                                ...
                                <div class='col-md-8'>
                                  <textarea name="equity_structure" class="form-control"><?php echo ($user['equity_structure']); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row margin_top_bottom_20">
                                ...
                                <div class='col-md-8'>
                                    <?php if($user['is_invested'] == 1): ?><input class="icheckbox_flat-blue" id="is_invested" type="radio" name="is_invested" value="0" />否&nbsp;&nbsp;&nbsp;
                                            <input class="icheckbox_flat-blue" id="is_invested" type="radio" name="is_invested" value="1" checked/>是
                                    <?php else: ?>
                                            
                                            <input class="icheckbox_flat-blue" id="is_invested" type="radio" name="is_invested" value="0" checked/>否&nbsp;&nbsp;&nbsp;
                                            <input class="icheckbox_flat-blue" id="is_invested" type="radio" name="is_invested" value="1" />是<?php endif; ?>
                                </div>
                            </div>

                            <?php if($user['is_invested'] == 1): ?><div class="row margin_top_bottom_20">
                                      <div class='col-md-3 text_right'>
                                          轮次:
                                      </div>
                                      <div class='col-md-8'>
                                          <input type="text" class="form-control" name="investment_round" value="<?php echo ($user['investment_round']); ?>">
                                      </div>
                                  </div>

                                  <div class="row margin_top_bottom_20">
                                    <div class='col-md-3 text_right'>额度(万人民币):</div>
                                    <div class='col-md-8'><input type="number" class="form-control" name="investment_quota" value="<?php echo ($user['investment_quota']); ?>"></div>
                                  </div>

                                  <div class="row margin_top_bottom_20">
                                    <div class='col-md-3 text_right'>投资方:</div>
                                    <div class='col-md-8'><input type="text" class="form-control" name="investor" value="<?php echo ($user['investor']); ?>"></div>
                                  </div><?php endif; ?>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="row margin_top_bottom_20">
                                ...
                                <div class='col-md-8'>
                                    <input type="text" class="form-control" name="plan_investment_round" value="<?php echo ($user['plan_investment_round']); ?>">
                                </div>
                            </div>

                            <div class="row margin_top_bottom_20">
                              <div class='col-md-3 text_right'>额度(万人民币):</div>
                              <div class='col-md-8'><input type="number" class="form-control" name="plan_invested_quota" value="<?php echo ($user['plan_invested_quota']); ?>"></div>
                            </div>

                            <div class="row margin_top_bottom_20">
                              <div class='col-md-3 text_right'>出让股份(%):</div>
                              <div class='col-md-8'><input type="number" class="form-control" name="plan_transfer_shares" value="<?php echo ($user['plan_transfer_shares']); ?>"></div>
                            </div>

                            <div class="row margin_top_bottom_20">
                              <div class='col-md-3 text_right'>融资用途:</div>
                              <div class='col-md-8'><textarea name="plan_to_do" class="form-control"><?php echo ($user['plan_to_do']); ?></textarea></div>
                            </div>
                            ...
                            <div class="row margin_top_bottom_20">
                                ...
                                <div class='col-md-8'>
                                    <?php if($user['accept_joint_investment'] == 1): ?><input class="icheckbox_flat-blue" id="accept_joint_investment" type="radio" name="accept_joint_investment" value="0" />否&nbsp;&nbsp;&nbsp;
                                            <input class="icheckbox_flat-blue" id="accept_joint_investment" type="radio" name="accept_joint_investment" value="1" checked/>是
                                    <?php else: ?>
                                            
                                            <input class="icheckbox_flat-blue" id="accept_joint_investment" type="radio" name="accept_joint_investment" value="0" checked/>否&nbsp;&nbsp;&nbsp;
                                            <input class="icheckbox_flat-blue" id="accept_joint_investment" type="radio" name="accept_joint_investment" value="1" />是<?php endif; ?>
                            ...
                            <div class="row margin_top_bottom_20">
                              ...
                              <div class='col-md-8'><a href="/fofs/1/Public/uploads/startup_bp/<?php echo ($user['bp_url']); ?>" target="_Blank" >查看已有bp</a><input type="file" class="form-control" name="bp_url" ></div>
