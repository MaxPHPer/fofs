              ...
              <div class="row margin_top_20">
                  <div class='col-md-12' >
                      ...
                      <div class="panel-body">
                          ...
                          <form class="form-horizontal" action="<?php echo U('Home/Startups/do_sendLetter');?>"  method="post" >
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="text" class="form-control"  value="<?php echo ($recipient['recipient_name']); ?>" disabled />
                                    <input type="hidden" class="form-control" id="userName" name="recipient_name" value="<?php echo ($recipient['recipient_name']); ?>"  required/>  
                                    <input type="hidden" class="form-control" id="recipient_id" name="recipient_id" value="<?php echo ($recipient['recipient_id']); ?>" />
                                    <input type="hidden" class="form-control" id="recipient_type" name="recipient_type" value="<?php echo ($recipient['recipient_type']); ?>" />       
                                  </div>
                                </div>
