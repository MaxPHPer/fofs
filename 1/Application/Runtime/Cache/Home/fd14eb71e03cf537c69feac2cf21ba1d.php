                      ...
                      <div class='col-md-12' >
                                <div class="panel-body">
                                    ...
                                    <?php if(is_array($results)): foreach($results as $key=>$vo): ?><div class="list-group-item row form-group">
                                          ...
                                          <div class="col-sm-2">
                                            <img class="media-object img-thumbnail" src="/fofs/1/Public/uploads/startup_pic/<?php echo $vo['institution_logo_img']?$vo['institution_logo_img']:'default.jpg'; ?>" alt="头像"  width="100"/>
                                          </div>
                                          <div class="col-sm-5" style="margin-top:18px;">
                                               <a href="<?php echo U('Home/Search/startUpProfile');?>?id=<?php echo ($vo['id']); ?>&institution_type=<?php echo ($vo['institution_type']); ?>" target="_blank"><?php echo ($vo['institution_abbr']); ?></a>
                                          </div>

                                          <div class="col-sm-3" style="margin-top:18px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">
                                               <?php echo ($vo['institution_abstract']); ?>
                                          </div>
