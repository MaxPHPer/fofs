          ...
          <div class="col-md-8">
            <div class="well">
              ...
              <div class="row margin_top_20">
                  <div class='col-md-12'>
                  <h3><span class="glyphicon glyphicon-home"></span>账号信息(<a href="<?php echo U('Home/Startups/modifyPersonalInfo');?>">修改</a>)</h3>
                    <div class="panel panel-default">
                      <div class="panel-body">
                  ...
                  <div class='col-md-12'>
                    <h3><span class="glyphicon glyphicon-check"></span>修改密码</h3>
                        <div class="alert alert-danger" role="alert">
                            <form method="post" action="<?php echo U('Home/Startups/set_password');?>">
