                    ...
                    <!--已有基金产品-->
                        ...
                        <div class="repeat">
                          <div class="row" style="margin-top:10px;">
                              ...
                              <div>
                                  <div class="col-sm-3 text_right">
                                    <span class="glyphicon glyphicon-tree-deciduous"></span>基金项目名称
                                  </div>
                                  <div class="col-sm-4">
                        ...
                        <div class="row">
                              <div class="col-sm-3">
                                <button type="submit" class="btn btn-primary" id="" onclick="form1.action='/fofs/1/index.php/Home/Gp/do_addFund';form1.submit();">保存新增</button>
                              </div>
                        </div>
