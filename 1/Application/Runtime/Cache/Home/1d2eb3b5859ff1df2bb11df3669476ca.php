                                ...
                                <div class="row" style="margin-top:10px;">
                                    ...
                                    <div>
                                        ...
                                        <div class="col-sm-5 text_right">
                                              <span class="glyphicon glyphicon-pencil"></span><a href="<?php echo U('Home/Sa/modifyCase');?>?id=<?php echo ($vo['id']); ?>">修改</a>&nbsp;<span class="glyphicon glyphicon-trash"></span><a href="<?php echo U('Home/Sa/deleteCase');?>?id=<?php echo ($vo['id']); ?>">删除</a>
                                        </div>
                                    </div>
