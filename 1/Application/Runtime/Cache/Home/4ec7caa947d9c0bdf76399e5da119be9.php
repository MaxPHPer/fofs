                  ...
                  <div class="panel-body">
                      ...
                      <div class='col-md-12' >
                          ...
                          <ul class="nav nav-tabs" role="tablist" style="padding-left:15px; padding-right: 15px;">
                            <li role="presentation" class="<?php if($institution_type==4) echo 'active'; ?>" ><a href="<?php echo U('Home/Search/saSearch?institution_type=4');?>" >Fa机构</a></li>
                            <li role="presentation" class="<?php if($institution_type==5) echo 'active'; ?>"><a href="<?php echo U('Home/Search/saSearch?institution_type=5');?>" >法务机构</a></li>
                            <li role="presentation" class="<?php if($institution_type==6) echo 'active'; ?>"><a href="<?php echo U('Home/Search/saSearch?institution_type=6');?>" >财务机构</a></li>
                            <li role="presentation" class="<?php if($institution_type==7) echo 'active'; ?>"><a href="<?php echo U('Home/Search/saSearch?institution_type=7');?>" >众创空间</a></li>
                            <li role="presentation" class="<?php if($institution_type==8) echo 'active'; ?>"><a href="<?php echo U('Home/Search/saSearch?institution_type=8');?>" >其它机构</a></li>
                          </ul>

                          <!-- Tab panes -->
                          <div class="tab-content">
                            <div role="tabpanel" class="tab-pane <?php if($institution_type==4) echo 'active'; ?>" id="all">
                                <div class="panel-body">
                                    <div class="list-group">
                                    <?php if(is_array($results1)): foreach($results1 as $key=>$vo): ?><div class="list-group-item row form-group">
                                          <div class="col-sm-1 " style="margin-top:18px;">
                                              <?php echo ($key+1); ?>
                                          </div>
                                     
                                          <div class="col-sm-2">
                                            <img class="media-object img-thumbnail" src="/fofs/1/Public/uploads/fa_pic/<?php echo $vo['institution_logo_img']?$vo['institution_logo_img']:'default.jpg'; ?>" alt="头像"  width="100"/>
                                          </div>
                                          <div class="col-sm-5" style="margin-top:18px;">
                                               <a href="<?php echo U('Home/Search/saProfile');?>?id=<?php echo ($vo['id']); ?>&institution_type=<?php echo ($vo['institution_type']); ?>" target="_blank"><?php echo ($vo['institution_fullname_cn']); ?></a>
                                          </div>

                                          <div class="col-sm-3" style="margin-top:18px;">
                                              <?php if($vo['institution_type'] == 4): ?>Fa机构<?php endif; ?>
                                              <?php if($vo['institution_type'] == 5): ?>法务服务机构<?php endif; ?>
                                              <?php if($vo['institution_type'] == 6): ?>财务服务机构<?php endif; ?>
                                              <?php if($vo['institution_type'] == 7): ?>众创空间(孵化器)<?php endif; ?>
                                              <?php if($vo['institution_type'] == 8): ?>其它机构<?php endif; ?>
                                          </div>
                            ...
                            <div role="tabpanel" class="tab-pane <?php if($institution_type==5) echo 'active'; ?>" id="home">
                                <div class="panel-body">
                                    <div class="list-group">
                                    <?php if(is_array($results2)): foreach($results2 as $key=>$vo): ?><div class="list-group-item row form-group">
                                          <div class="col-sm-1 " style="margin-top:18px;">
                                              <?php echo ($key+1); ?>
                                          </div>
                                     
                                          <div class="col-sm-2">
                                            <img class="media-object img-thumbnail" src="/fofs/1/Public/uploads/la_pic/<?php echo $vo['institution_logo_img']?$vo['institution_logo_img']:'default.jpg'; ?>" alt="头像"  width="100"/>
                                          </div>
                                          <div class="col-sm-5" style="margin-top:18px;">
                                               <a href="<?php echo U('Home/Search/saProfile');?>?id=<?php echo ($vo['id']); ?>&institution_type=<?php echo ($vo['institution_type']); ?>" target="_blank"><?php echo ($vo['institution_fullname_cn']); ?></a>
                                          </div>
                            ...
                            <div role="tabpanel" class="tab-pane <?php if($institution_type==6) echo 'active'; ?>" id="profile">

                                <div class="panel-body">
                                    <div class="list-group">
                                    <?php if(is_array($results3)): foreach($results3 as $key=>$vo): ?><div class="list-group-item row form-group">
                                          <div class="col-sm-1 " style="margin-top:18px;">
                                              <?php echo ($key+1); ?>
                                          </div>
                                     
                                          <div class="col-sm-2">
                                            <img class="media-object img-thumbnail" src="/fofs/1/Public/uploads/fi_pic/<?php echo $vo['institution_logo_img']?$vo['institution_logo_img']:'default.jpg'; ?>" alt="头像"  width="100"/>
                                          </div>
                                          <div class="col-sm-5" style="margin-top:18px;">
                                               <a href="<?php echo U('Home/Search/saProfile');?>?id=<?php echo ($vo['id']); ?>&institution_type=<?php echo ($vo['institution_type']); ?>" target="_blank"><?php echo ($vo['institution_fullname_cn']); ?></a>
                                          </div>
                            ...
                            <div role="tabpanel" class="tab-pane <?php if($institution_type==7) echo 'active'; ?>" id="users">

                                <div class="panel-body">
                                    <div class="list-group">
                                    <?php if(is_array($results4)): foreach($results4 as $key=>$vo): ?><div class="list-group-item row form-group">
                                          <div class="col-sm-1 " style="margin-top:18px;">
                                              <?php echo ($key+1); ?>
                                          </div>
                                     
                                          <div class="col-sm-2">
                                            <img class="media-object img-thumbnail" src="/fofs/1/Public/uploads/bi_pic/<?php echo $vo['institution_logo_img']?$vo['institution_logo_img']:'default.jpg'; ?>" alt="头像"  width="100"/>
                                          </div>
                                          <div class="col-sm-5" style="margin-top:18px;">
                                               <a href="<?php echo U('Home/Search/saProfile');?>?id=<?php echo ($vo['id']); ?>&institution_type=<?php echo ($vo['institution_type']); ?>" target="_blank"><?php echo ($vo['institution_fullname_cn']); ?></a>
                                          </div>
                            ...
                            <div role="tabpanel" class="tab-pane <?php if($institution_type==8) echo 'active'; ?>" id="other">

                                <div class="panel-body">
                                    <div class="list-group">
                                    <?php if(is_array($results5)): foreach($results5 as $key=>$vo): ?><div class="list-group-item row form-group">
                                          <div class="col-sm-1 " style="margin-top:18px;">
                                              <?php echo ($key+1); ?>
                                          </div>
                                     
                                          <div class="col-sm-2">
                                            <img class="media-object img-thumbnail" src="/fofs/1/Public/uploads/other_pic/<?php echo $vo['institution_logo_img']?$vo['institution_logo_img']:'default.jpg'; ?>" alt="头像"  width="100"/>
                                          </div>
                                          <div class="col-sm-5" style="margin-top:18px;">
                                               <a href="<?php echo U('Home/Search/otherProfile');?>?id=<?php echo ($vo['id']); ?>&institution_type=<?php echo ($vo['institution_type']); ?>" target="_blank"><?php echo ($vo['institution_fullname_cn']); ?></a>
                                          </div>
