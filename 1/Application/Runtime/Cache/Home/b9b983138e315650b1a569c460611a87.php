                ...
                <div class="row">
                  <div class="col-sm-10 col-sm-offset-1">
                    ...
                    <div class="form-group clearfix">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" id="institution_fullname_cn"   value="<?php echo ($data['institution_fullname_cn']); ?>"  name="institution_fullname_cn"/>
                      </div>
                    </div>
                    <!--全称(中文)-->
                    ...
                    <div class="form-group clearfix">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" id="institution_fullname_en"   value="<?php echo ($data['institution_fullname_en']); ?>" name="institution_fullname_en"/>
                      </div>
                    </div>
                    <!--全称(英文)-->
                    ...
                    <div class="form-group clearfix">
                      <label for="founded_addr" class="col-sm-3 control-label">注册地点</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" id="founded_addr"   value="<?php echo ($data['founded_addr']); ?>" name="founded_addr"/>
                      </div>
                    </div>
                    <!--注册地点-->

                    <div class="form-group clearfix">
                      <label for="profession" class="col-sm-3 control-label">所属行业</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" id="profession"   value="<?php echo ($data['profession']); ?>" name="profession"/>
                      </div>
                    </div>
                    <!--所属行业-->
