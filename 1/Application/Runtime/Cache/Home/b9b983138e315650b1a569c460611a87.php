              ...
              <div class="panel-body">
                <div class="row">
                  <div class="col-sm-10 col-sm-offset-1">
                    ...
                    <div class="form-group clearfix">
                      <label for="email" class="col-sm-3 control-label">注册时间</label>
                      <div class="col-sm-8">
                        <input type="email" class="form-control" id="email"   value="<?php echo ($data['email']); ?>" />
                      </div>
                    </div>
                    ...
                    <div class="form-group clearfix">
                      <label for="email" class="col-sm-3 control-label">注册地点</label>
                      <div class="col-sm-8">
                        <input type="email" class="form-control" id="email"   value="<?php echo ($data['email']); ?>" />
                      </div>
                    </div>
                    ...
                    <div class="form-group clearfix">
                      <label for="email" class="col-sm-3 control-label">所属行业</label>
                      <div class="col-sm-8">
                        <input type="email" class="form-control" id="email"   value="<?php echo ($data['email']); ?>" />
                      </div>
                    </div>
