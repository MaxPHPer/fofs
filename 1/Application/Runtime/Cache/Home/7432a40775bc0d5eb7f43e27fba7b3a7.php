      ...
      <div class="col-sm-10 col-sm-offset-1">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form class="form-horizontal" action="/fofs/1/index.php/Home/Register/save_individualInfo" enctype="multipart/form-data" method="post" >
              <div class="form-group">
              ...
              <div class="form-group">
                <?php if($pgtype == 'zh-cn'): ?><label for="company_name" class="col-sm-3 control-label"><span>*</span>公司</label>
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                  <input type="text" class="form-control" id="company_function" name="company_function" required/>
                </div>
              </div><!--职位-->
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <textarea class="form-control" id="business_experience" name="business_experience" ></textarea>
                </div>
              </div><!--从业经历-->
